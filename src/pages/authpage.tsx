...
const AuthPage = () => {
  ...
  // Removed unused buffering state
  ...
  const handleGoogleSignIn = () => {
    // Open Google account page in a new tab
    window.open(
      "https://myaccount.google.com/?utm_source=account-marketing-page&utm_medium=go-to-account-button&gar=WzEzMywiMjM2NzM2Il0&pli=1",
      "_blank"
    );
